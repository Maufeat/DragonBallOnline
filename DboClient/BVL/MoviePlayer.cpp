...
RwBool CMoviePlayer::ReadyMovie(const char* pcFileName, eMovieSizeType eSizeType)
{
	...
	// Demo version displays the logo of the product ID and authentication key you have purchased to clear here.
	m_BVL.Verify(dBVL_NTL_ID, dBVL_NTL_PASSWARD);


	// To open a video file, the opening video is OpenAsync () instead of Open (), it is recommended that you use.
	...
	case MOVIE_SIZE_ORIGINAL:
		{
			// The movie's horizontal, vertical resolution, shall be located in the middle of the screen while preserving
	...
	case MOVIE_SIZE_RATIO_FULL:
		{
			// Video horizontal resolution and the screen resolution is the ratio of the horizontal resolution and the vertical length of the video, depending on the conditions
	...
	case MOVIE_SIZE_FULL:
		{
			// Video resolution of screen resolution of horizontal, vertical, horizontal resolution and a large percentage of the side
			// On the basis of increasing the length of the movie's tight on the screen horizontally, vertically, of course.
...
////////////////////////////////////////////////////////////////////////////////////////////////////
///         D3D To create a square plane in space there is a video texture investiture
/// @param  
/// @return 
