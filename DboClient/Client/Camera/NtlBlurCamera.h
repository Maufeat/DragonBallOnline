...
private:
	...
	// Gaussian
	enum { GAUSSION_WEIGHT_COUNT = 7, };									// The number to calculate the weights
	RwReal				m_fGaussainDispersion_sq;						// Dispersion of square roots
	RwReal				m_fGaussainWeightTable[GAUSSION_WEIGHT_COUNT];	// The weighting array
