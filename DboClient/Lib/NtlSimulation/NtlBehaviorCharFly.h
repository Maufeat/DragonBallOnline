 ...
 * \author agebreak
 */
class CNtlBehaviorCharFly : public CNtlBehaviorCharMove
{
    DECLEAR_MEMORY_POOL(CNtlBehaviorCharFly, NTL_DEFAULT_MEMORY_POOL)
    DECLEAR_BEHAVIOR_FACTROY(CNtlBehaviorCharFly)
...
private:
    ...
    void ChangeFlyState(RwUInt8 byJumpState);
};
