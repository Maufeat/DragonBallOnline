...
enum EDispStingType
{
	...
	DST_ITEM_CAN_NOT_USE_NO_DOJO_SCRAMBLE_SEAL,		// 인장 제어기는 도장 쟁탈전 진행중 인장에만 사용할 수 있습니다(인장 제어기를 인장이 아닌 것에 쓰려고 할 때)
	...
	DST_DELIBERATION_RANK_MESSAGE_2,				// 게임을 2시간 이용했습니다. 지나친 게임 플레이는 건강을 해칠 수 있습니다.
	DST_DELIBERATION_RANK_MESSAGE_3,				// 게임을 3시간 이용했습니다. 건강을 위해서 잠시 쉬었다 하세요
	DST_DELIBERATION_RANK_MESSAGE_4,				// 게임을 4시간 이용했습니다. 지나친 게임 플레이는 건강을 해칠 수 있습니다.
	DST_DELIBERATION_RANK_MESSAGE_5,				// 게임을 5시간 이용했습니다. 지나친 게임 플레이는 건강을 해칠 수 있습니다.
	DST_DELIBERATION_RANK_MESSAGE_WARING_1,			// 장시간 사용은 피부미용에 해롭습니다

	// 퀵슬롯
	DST_QUICKSLOT_IS_LOCK,					// 퀵슬롯이 잠김상태입니다. 

	// 채팅
	DST_CHAT_CAN_SEND_WHISPER_TO_ME,			// 자기 자신에게 귓속말을 보낼 수 없습니다(자기 자신에게 귓속말을 하려 할 때)
